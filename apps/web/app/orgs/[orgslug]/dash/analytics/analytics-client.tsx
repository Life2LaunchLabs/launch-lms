...
const AdvancedGate = dynamic(() =>
  import('@components/Dashboard/Analytics/AdvancedGate').then((mod) => ({
    default: mod.AdvancedGate,
  }))
)
...
const ContentTypeEffectiveness = dynamic(() =>
  import('@components/Dashboard/Analytics/ContentTypeEffectiveness')
)
...
const LearnerEngagementScore = dynamic(() =>
  import('@components/Dashboard/Analytics/LearnerEngagementScore')
)
const CourseEffectivenessMatrix = dynamic(() =>
  import('@components/Dashboard/Analytics/CourseEffectivenessMatrix')
)
        ...
        <div className="my-2 py-2">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div className="flex flex-col space-y-1">
              <div className="pt-3 flex font-bold text-4xl tracking-tighter">{t('analytics.title')}</div>
              <div className="flex font-medium text-gray-400 text-md">{t('analytics.subtitle')}</div>
            </div>
            ...
            >
              <div className="flex items-center space-x-2.5 mx-2">
                ...
                <div className="flex items-center">
                  ...
                  {!isAdvanced && <PlanBadge currentPlan={plan} requiredPlan="enterprise" />}
                </div>
              </div>
            </div>
          </button>
