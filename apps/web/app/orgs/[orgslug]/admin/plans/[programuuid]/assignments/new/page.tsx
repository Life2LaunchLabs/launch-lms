...
export default async function NewPlanAssignmentPage({ params, searchParams }: { params: Promise<{ orgslug: string; programuuid: string }>; searchParams: Promise<{ groupId?: string }> }) {
