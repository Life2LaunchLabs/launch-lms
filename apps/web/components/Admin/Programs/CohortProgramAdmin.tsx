...
export function GroupProgramMatrix({ orgslug, groupId, assignmentUuid }: { orgslug: string; groupId: number; assignmentUuid: string }) {
  ...
  return (
    <main className="min-h-full w-full bg-[#f8f8f8] px-6 py-6">
      <div className="mx-auto max-w-[1500px]">
        ...
        <Link href={getUriWithOrg(orgslug, routePaths.org.dash.users.group(groupId))} className="mt-4 inline-flex items-center gap-1.5 text-sm font-semibold text-blue-600 hover:text-blue-800"><ArrowLeft size={14} />Group overview</Link>
