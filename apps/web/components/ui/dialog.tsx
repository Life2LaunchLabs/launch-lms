  ...
  <DialogPortal>
    <div style={{ position: 'fixed', inset: 0, zIndex: 'var(--z-modal)', pointerEvents: 'none' }}>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "fixed left-[50%] top-[50%] grid w-full max-w-lg translate-x-[-50%] translate-y-[-50%] gap-0 border border-border/80 bg-popover p-6 text-popover-foreground shadow-2xl shadow-black/10 duration-200 sm:rounded-2xl",
