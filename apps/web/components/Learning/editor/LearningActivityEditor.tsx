...
function CanvasBlock({ block, page, selected, readOnly, registerBlockEl, onHoverBlock, onTextEditorReady, onSelect, onPatch, onRequestImageUpload }: {
  ...
  const content = block.type === 'text' ? (
    ...
    <TimelineCardView preview entry={{ timeline_uuid: 'preview', slug: 'preview', entry_type: 'education', title: 'Your current chapter', organization: 'Your school or organization', location_label: 'Your location', summary: 'Your story will appear here.', start_date: '2026-01', start_precision: 'month', is_current: true, revision: 1, cover_url: '', blocks: [], work: [] } as TimelineEntry} />
