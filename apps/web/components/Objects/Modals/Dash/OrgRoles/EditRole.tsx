            ...
            <FormLayout onSubmit={formik.handleSubmit}>
                <div className="grid grid-cols-1 xl:grid-cols-2 gap-4 sm:gap-6">
                    <div className="space-y-4 sm:space-y-6">
                        ...
                        <div className="mt-6">
                            <h3 className="text-lg font-semibold text-foreground mb-4">Predefined Rights</h3>
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                                {Object.keys(predefinedRoles).map((roleKey) => (
                                    ...
                                    >
                                        <div className="font-medium text-foreground text-sm sm:text-base">{predefinedRoles[roleKey as keyof typeof predefinedRoles].name}</div>
                                        <div className="text-xs sm:text-sm text-muted-foreground mt-1">{predefinedRoles[roleKey as keyof typeof predefinedRoles].description}</div>
                                    </button>
                                ))}
                            </div>
                        </div>
                    ...
                    <div className="space-y-4">
                        <h3 className="text-lg font-semibold text-foreground mb-4">{t('dashboard.users.roles.modals.edit.permissions.title')}</h3>
                        
                        <PermissionSection
                            title={t('dashboard.users.roles.modals.edit.permissions.sections.badges')}
                            icon={BookOpen}
                            section="badges"
                        ...
                        <PermissionSection
                            title={t('dashboard.users.roles.modals.edit.permissions.sections.badge_collections')}
                            icon={FolderOpen}
                        ...
                        <PermissionSection
                            title={t('dashboard.users.roles.modals.edit.permissions.sections.learning_activities')}
                            icon={Activity}
