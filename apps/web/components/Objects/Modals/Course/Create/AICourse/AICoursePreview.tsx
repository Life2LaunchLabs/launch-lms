...
function ActivityItem({ activity, activityIndex, chapterIndex, plan, onUpdatePlan }: {
  ...
  return (
    <div className="bg-white/5 rounded-xl ring-1 ring-inset ring-white/10 overflow-hidden">
      ...
      {expanded && (
        <div className="px-4 pb-3 space-y-2">
          {chapter.activities.map((activity, ai) => (
            <ActivityItem key={ai} activity={activity} activityIndex={ai} chapterIndex={chapterIndex} plan={plan} onUpdatePlan={onUpdatePlan} />
          ))}
