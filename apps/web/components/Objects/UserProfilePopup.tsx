        ...
        {isLoading ? (
          ...
          <div>
            ...
            <div className="relative">
              {/* Background gradient */}
              <div className="absolute inset-0 bg-gradient-to-b from-muted/30 to-transparent h-28 rounded-t-lg" />
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between gap-2">
                      <div className="flex items-center gap-2 min-w-0">
                        ...
                        {userData.username && (
                          <Badge variant="outline" className="text-xs font-normal text-muted-foreground px-2 truncate">
                            @{userData.username}
                          </Badge>
                        )}
                      </div>
                    ...
                    {userData.bio && (
                      <p className="text-sm text-muted-foreground mt-1.5 line-clamp-4 leading-normal">
                        {userData.bio}
                      </p>
                    )}
                  </div>
