...
import usePlanInvitations from '@components/Hooks/usePlanInvitations'
...
export const OrgMenu = (props: { orgslug: string }) => {
  ...
  const { unreadCount: planUnreadCount } = usePlanInvitations()
  const unreadCount = organizationUnreadCount + planUnreadCount
