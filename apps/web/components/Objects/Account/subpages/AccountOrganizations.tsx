      ...
      <div className="mb-8 flex flex-col gap-4">
        ...
        <div className="relative max-w-xl">
          <input
            ...
            className="h-12 w-full rounded-2xl border border-border bg-muted pl-12 pr-4 text-sm shadow-sm outline-none transition focus:border-border focus:ring-2 focus:ring-black/5"
          />
