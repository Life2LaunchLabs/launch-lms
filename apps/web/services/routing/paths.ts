...
export const routePaths = {
  ...
  org: {
    ...
    journeyRoadmapOption: (roadmapUuid: string) => `/journey/roadmap/${roadmapUuid}`,
    journeyRoadmapExplore: () => '/journey/roadmap/explore',
    journeyRoadmapDetails: (roadmapUuid?: string) => withQuery('/journey/roadmap/details', { path: roadmapUuid }),
    podcasts: () => '/podcasts',
    courses: () => '/courses',
