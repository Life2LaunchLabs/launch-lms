  ...
  org: {
    ...
    dash: {
      ...
      users: {
        ...
        groupProgram: (groupId: string | number, assignmentUuid: string) => `/admin/users/groups/${encodeURIComponent(String(groupId))}/programs/${encodeURIComponent(assignmentUuid)}`,
        ...
        cohortProgram: (groupId: string | number, assignmentUuid: string) => `/admin/users/groups/${encodeURIComponent(String(groupId))}/programs/${encodeURIComponent(assignmentUuid)}`,
      },
      orgSettings: {
