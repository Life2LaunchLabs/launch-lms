...
export const updateMyPortfolioFeaturedWork = (payload: { work_uuid?: string | null; work_uuids?: string[] }, token: string) => mutate('me/featured-work', 'PUT', payload, token)
export const updateMyPortfolioFeaturedJourney = (payload: { journey_uuids: string[] }, token: string) => mutate('me/featured-journey', 'PUT', payload, token)
