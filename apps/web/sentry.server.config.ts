...
let SENTRY_DSN = process.env.NEXT_PUBLIC_LAUNCHLMS_SENTRY_DSN;
let LEARNHOUSE_ENV = process.env.NEXT_PUBLIC_LAUNCHLMS_ENV || "dev";
  ...
  for (const configPath of possiblePaths) {
    try {
      if (fs.existsSync(configPath)) {
        ...
        SENTRY_DSN = rc.NEXT_PUBLIC_LAUNCHLMS_SENTRY_DSN || SENTRY_DSN;
        LEARNHOUSE_ENV = rc.NEXT_PUBLIC_LAUNCHLMS_ENV || LEARNHOUSE_ENV;
        break;
      }
    } catch {
