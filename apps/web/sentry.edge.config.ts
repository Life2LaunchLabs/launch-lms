...
const SENTRY_DSN = process.env.NEXT_PUBLIC_LAUNCHLMS_SENTRY_DSN || process.env.LEARNHOUSE_SENTRY_DSN;
const LEARNHOUSE_ENV = process.env.NEXT_PUBLIC_LAUNCHLMS_ENV || process.env.LEARNHOUSE_ENV || "dev";
