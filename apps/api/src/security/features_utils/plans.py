...
# Features only gated by packages (analytics, AI,
...
PLAN_FEATURE_CONFIGS: dict[str, dict] = {
    "free": {
        "features": {
            ...
            "badge_collections": {"enabled": True, "limit": 1},
            ...
            "marketplace_publishing": {"enabled": False},
            "badge_issuing": {"enabled": False},
        },
    ...
    "full": {
        "features": {
            ...
            "podcasts": {"enabled": False, "limit": 0},
            "boards": {"enabled": False, "limit": 0},
            "badge_collections": {"enabled": True, "limit": 5},
            "communities": {"enabled": False, "limit": 0},
            ...
            "versioning": {"enabled": False},
            "audit_logs": {"enabled": False},
            # Packages required; enabled per-org by badge_creation / badge_issuing packages
            "marketplace_publishing": {"enabled": False},
            "badge_issuing": {"enabled": False},
        },
    ...
    "enterprise": {
        "features": {
            ...
            "badge_collections": {"enabled": True, "limit": 0},
            "communities": {"enabled": False, "limit": 0},
            ...
            "marketplace_publishing": {"enabled": True},
            "badge_issuing": {"enabled": True},
        },
...
PLAN_LIMITS: dict[str, dict[str, int]] = {
    plan: {
        "badges": cfg["features"]["badges"]["limit"],
        "members": cfg["features"]["members"]["limit"],
        "admin_seats": cfg["features"]["members"]["admin_limit"],
        "badge_collections": cfg["features"]["badge_collections"]["limit"],
    }
