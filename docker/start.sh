...
pm2 start server-wrapper.js --cwd /app/web --name launch-lms-web > /dev/null 2>&1
pm2 start uv --cwd /app/api --name launch-lms-api -- run app.py
pm2 start node --cwd /app/collab --name launch-lms-collab -- dist/index.js
