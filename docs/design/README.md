...
| Hub Chat, Search, and Work composer selector | BOT-205; PATHWAYS-G006-A001/A004; RESOURCES-G001-A002 | [Browser verification](../../scripts/docs/BOT-205-hub-modes-verification.md) | Current Hub plus adopted Button/Textarea patterns; owner signoff pending |
